...
const withAttribution = args.includes('-a') || args.includes('--attribution');
...
const printHelp = () => {
  ...
  console.log(`  ${chalk.green('commit-suggester -a, --attribution')} ${chalk.dim('# Append commit-suggester credit to message')}`);
...
const main = async (): Promise<void> => {
  ...
  try {
    ...
    if (withAttribution) {
      finalMessage += '\n\nCommit message generated by commit-suggester';
    }
